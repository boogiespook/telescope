<!DOCTYPE html>
  <html lang="en-us">
    <head>
      ...
      <title data-react-helmet="true">Red Hat Advanced Cluster Governance</title>
...
function putProject($projectTitle) {
  print '<h2 class="pf-c-title pf-m-xl">' . $projectTitle . '</h2>
            ...
            <div class="pf-c-page" id="page-default-nav-example">
              ...
              <header class="pf-c-page__header">
                <div class="pf-c-page__header-brand">
                  ...
                  <img class="pf-c-brand" src="/assets/images/logo.png" alt="Red Hat logo" />
                  </a>
                </div>
                  ...
                  <nav class="pf-c-nav" id="page-default-nav-example-primary-nav" aria-label="Global">
                    <ul class="pf-c-nav__list">
                      <li class="pf-c-nav__item">
                        <a href="#" class="pf-c-nav__link pf-m-current" aria-current="page">Dashboard </a>
                      </li>
                      <li class="pf-c-nav__item">
                  ...
                  <nav class="pf-c-breadcrumb" aria-label="breadcrumb">
                    <ol class="pf-c-breadcrumb__list">
                      <li class="pf-c-breadcrumb__item">
                        <a href="#" class="pf-c-breadcrumb__link">RHACG home</a>
                      </li>
                      <li class="pf-c-breadcrumb__item">
...
<section class="pf-c-page__main-section pf-m-center">
  ...
  <?php 
putProject("Project Blue Iron");  
putProject("Project Booster");  
putProject("Project Christmas Bauble");  
putProject("Project Flammkuchen");  
?>
<br><hr><br>  
